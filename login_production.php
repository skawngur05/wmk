<?php
// Enable debug mode for troubleshooting (remove this line in production)
define('WMK_DEBUG', true);
...
$page_title = 'Login - Wrap My Kitchen CRM';
?>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card shadow-lg mt-5">
                    <div class="card-body p-5">
                        ...
                        <?php if (defined('WMK_DEBUG') && WMK_DEBUG): ?>
